<template>
    <div id="MainLayout" class="h-screen">
        ...
        <div id="bottomNav" class="fixed bottom-0 flex w-full h-[70px] border-t border-t-gray-700 bg-black">
            <div class="flex w-full max-w-[500px] mx-auto items-center justify-around">
                ...
                <button @click="userStore.isLogoutOverlay = true" class="w-full h-full">
                    <Icon name="material-symbols:exit-to-app-sharp" size="32" color="#ffffff" />
                </button>
